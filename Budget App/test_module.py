...
class UnitTests(unittest.TestCase):
    ...
    def test_deposit_no_description(self): #PASS
    ...
    def test_withdraw_no_description(self): #PASS
        self.food.deposit(900, "deposit")
    ...
    def test_check_funds(self): #PASS
    ...
    def test_withdraw_no_funds(self): #PASS
    ...
    def test_transfer_no_funds(self): #PASS
        self.food.deposit(100, "deposit")
